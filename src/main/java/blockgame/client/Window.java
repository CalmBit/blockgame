...
import blockgame.render.world.camera.Camera;
import blockgame.render.world.camera.ViewProj;
...
import blockgame.render.gui.GuiLoadingScreen;
import blockgame.render.gui.GuiPauseScreen;
import blockgame.render.gui.GuiRenderer;
import blockgame.render.gui.GuiSplashScreen;
import blockgame.util.FloatListCache;
import blockgame.util.worker.BindChunkQueue;
import blockgame.util.worker.DecoratorPool;
    ...
    public void renderGui(Runtime runtime) {
        ...
        switch(_state) {
            ...
            case LOADING:
                ...
                FontRenderer.DEFAULT.draw(_proj);
            ...
            case INGAME:
                ...
                FontRenderer.DEFAULT.renderTextWithFrame(
                        4.0f,
                        2.0f,
